...
export interface IAccountClient {
    login(command: LoginCommand): Observable<number>;
}
...
export interface ITodoItemsClient {
    create(command: LoginCommand2): Observable<number>;
...
export class LoginCommand2 implements ILoginCommand2 {
    listId?: number;
    title?: string | undefined;

    constructor(data?: ILoginCommand2) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LoginCommand2 {
        data = typeof data === 'object' ? data : {};
        let result = new LoginCommand2();
        result.init(data);
        return result;
    }
...
export interface ILoginCommand2 {
    listId?: number;
    title?: string | undefined;
}
